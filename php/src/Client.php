...
namespace APIVerve\Humannameparser;
...
/**
 * Client for the Human Name Parser API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/humannameparser?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/humannameparser';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HumannameparserClient] {$message}\n";
        }
    }
}
