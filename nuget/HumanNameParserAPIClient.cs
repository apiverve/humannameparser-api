...
namespace APIVerve.API.HumanNameParser
{
    ...
    /// <summary>
    /// Client for the HumanNameParser API
    /// </summary>
    public class HumanNameParserAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/humannameparser";
        ...
        public HumanNameParserAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HumanNameParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HumanNameParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HumanNameParserQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(HumanNameParserQueryOptions options)
        {
        ...
        public ResponseObj Execute(HumanNameParserQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HumanNameParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HumanNameParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HumanNameParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HumanNameParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HumanNameParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HumanNameParserQueryOptions options)
        {
