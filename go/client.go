// Package humannameparser provides a Go client for the Human Name Parser API.
//
// For more information, visit: https://apiverve.com/marketplace/humannameparser?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/humannameparser"
	defaultTimeout = 30 * time.Second
)

// Client is the Human Name Parser API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Human Name Parser API client.
...
// Execute makes a request to the Human Name Parser API with typed parameters.
//
...
//   - name (required): string - The human name to parse
