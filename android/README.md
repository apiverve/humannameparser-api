...
```gradle
dependencies {
    implementation 'com.github.apiverve:humannameparser-api:1.1.13'
}
```
...
```java
import com.apiverve.humannameparser.HumanNameParserAPIClient;
import com.apiverve.humannameparser.APIResponse;
import com.apiverve.humannameparser.APIException;

// Initialize the client
HumanNameParserAPIClient client = new HumanNameParserAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "MR. MARTINO PETROS DE FLORENCE (TINO) Jr.");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/humannameparser](https://docs.apiverve.com/ref/humannameparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/humannameparser](https://docs.apiverve.com/ref/humannameparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/humannameparser-api/issues)
